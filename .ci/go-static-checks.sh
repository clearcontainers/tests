...
# May not be necessary for CI machine runs, but enables local runs for some
# users
...
# process everything in the tree, apart from any vendor bits, as they are
# not our responsibility to check and fix
[ -z "$go_packages" ] && {
...
# Ensure the checkers are installed and upto date
